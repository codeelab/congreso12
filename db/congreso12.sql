...
(9, 'Mesa 9.- Innovación, Competitividad, Desarrollo Regional y Gobierno Digital'),
(10, 'Mesa 10.- Experiencias de vinculación e integración del conocimiento con las necesidades del Estado');
...
CREATE TABLE `usuarios` (
  ...
  `area_id` int(11) DEFAULT NULL,
  `mailing` text CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
--
ALTER TABLE `nivel_academico`
  MODIFY `id_academico` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
