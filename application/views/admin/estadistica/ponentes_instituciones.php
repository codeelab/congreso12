...
<div class="container">
<div class="center">
<h2>REPORTE GENERAL INSTITUCIONES</h2>
</div>

<div class="gap"></div>
<div id="pricing-table" class="row">
<?php
foreach($institu as $obj){
        $id_institucion = $obj->id_institucion;
            ...
            <div class="col-md-4 col-sm-6">
                <section class="panel panel-box">
                    ...
                    <div class="panel-right panel-icon bg-reverse">
                        ...
                        <a href="estadisticas_ponentes_facultades/'.$id_institucion.'"><p class="text-muted no-margin text"><span>'.$nombre_ins = $obj->nombre_ins.'</span></p></a>
                    </div>
                </section>
            </div>
