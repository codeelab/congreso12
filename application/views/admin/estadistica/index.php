...
<div class="container">
<div class="center">
<h2>ESTADÍSTICAS CONGRESO <?=date('Y');?></h2>
</div>
...
<a href="<?=base_url() ?>admin/estadisticas_ponentes" class="btn btn-outlined btn-white" data-wow-delay="0.7s"><i class="fa fa-share" aria-hidden="true"></i>   Acceder</a>
</li>
</ul>
</div>
