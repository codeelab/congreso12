                ...
                <div class="row dashboard-stats">
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_third"><?php $a = $tot * 100; $poru = round($a / $asistencia,2); echo $tot.' - '.$poru.'%';?></p>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <section class="panel panel-box">
                                ...
                                <div class="panel-right panel-icon bg-reverse">
                                    <p class="size-h1 no-margin countdown_third"><?php $a = $tot * 100; $port = round($a / $asistencia,2); echo $tot.' - '.$port.'%';?></p>
...
<?php
    $nombre = array();
    foreach($charuno as $result)
        {
         $unos[] =  (int) $result->uno;
        }
    foreach($chardos as $result)
        {
         $doss[] =  (int) $result->dos;
        }
    foreach($chartres as $result)
        {
         $tress[] =  (int) $result->tres;
        }
?>
<div class="row">
...
Highcharts.chart('container', {
    ...
    xAxis: {
        categories: ['Edad 18 - 30', 'Edad 31 - 50', 'Edad 51 - 100']
    },
    credits: {
        enabled: false
    },
    series: [{
        ...
        name: 'Edad 51 - 100',
        data:  <?php echo json_encode($tress);?>
    }],
