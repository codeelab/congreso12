...
<div class="container">
<div class="center">
<h2>REPORTE GENERAL FACULTADES</h2>
</div>

<div class="gap"></div>
<div id="pricing-table" class="row">
<?php
foreach($facultad as $obj){
        $id_facultad = $obj->id_facultad;
            ...
            <div class="col-md-4 col-sm-4">
                <section class="panel panel-box">
                    ...
                    <div class="panel-right panel-icon bg-reverse">
                        ...
                        <p class="text-muted no-margin text"><span>'.$nombre_fac = $obj->nombre_fac.'</span></p>
                    </div>
                </section>
            </div>
