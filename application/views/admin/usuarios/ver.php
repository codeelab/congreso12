...
<div class="row">
    <div class="col-lg-12">
    <a class="btn btn-success" href="<?=base_url();?>admin/total_usuarios" role="button"><span class="fa fa-mail-reply-all"></span>  Regresar</a>
    <a class="btn btn-success" href="<?=base_url();?>admin/uPDF/<?=$folio;?>" target="_blank" role="button"><span class="fa fa-file-pdf-o"></span>  PDF</a>
    <a class="btn btn-success" href="<?=base_url();?>admin/uExcel/<?=$folio;?>" role="button"><span class="fa fa-file-excel-o"></span>  EXCEL</a>
    </div>
</div>
<hr>
<div class="row">
