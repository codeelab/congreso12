...
echo form_open('inicio/registro_moderador', $atrib); ?>
        <div class="row">
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-4">
                <label class="form-text" for="mesa">Mesa</label>
                <select name="mesa" id="mesa" class="form-control">
                <option value="">Elige el área temática</option>
                <?php
                foreach ($mesa as $i => $nombre_tem)
                   echo '<option value="',$i,'">',$nombre_tem,'</option>';
                ?>
                </select>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            ...
            <input type="hidden" class="form-control" id="puesto" name="puesto" value="moderador">
