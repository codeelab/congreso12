<?php
  ...
  //Para los avisos de subida de resumen y cierre del módulo a todos los moderadors
  $inicio_aviso_moderador = "17/04/2017";
  $cierre_aviso_moderador = "28/04/2017";
  //Para los avisos de subida de extensos y cierre del módulo a todos los moderadors aprobados
...
<div class="container">
<?php
if ($actual >= $inicio_aviso_moderador AND $actual < $cierre_aviso_moderador) {
...
}else if ($actual == $cierre_aviso_moderador) {
...
<?php
if ( $actual >= $cierre_aviso_moderador) {
