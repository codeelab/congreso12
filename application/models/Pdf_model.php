...
class Pdf_model extends CI_Model {
 ...
 //---------------------------------------------------------------------
 // LISTA TODO EL CONTENIDO DE LOS USUARIOS TOTALES REGISTRADOS A PDF
 //---------------------------------------------------------------------

    //PDF GENERAL
    public function getUsuariosTotalPdf()
    {
    ...
    //PONENTES
    public function getUsuariosPDFPonentes()
    {
      $this->db->select('u.id_usuarios, u.username, u.nombre, u.a_paterno, u.a_materno, u.edad, g.nombre_gen, n.nombre_nac, e.nombre_est, m.nombre_mun, u.email, i.nombre_ins, f.nombre_fac, a.nombre_aca, IFNULL(t.nombre_tem, "NULL") nombre_tem, IFNULL(ti.nombre_trabajo, "NULL")nombre_trabajo, IFNULL(ap.nombre_area_apoyo,"NULL") nombre_area_apoyo, u.mailing, p.nombre_puesto, u.status');
      $this->db->from('usuarios u');
      $this->db->join('puesto p','u.puesto = id_puesto', 'inner');
    ...
    //MODERADORES
    public function getUsuariosPDFModerador()
    {
      $this->db->select('u.id_usuarios, u.username, u.nombre, u.a_paterno, u.a_materno, u.edad, g.nombre_gen, n.nombre_nac, e.nombre_est, m.nombre_mun, u.email, i.nombre_ins, f.nombre_fac, a.nombre_aca, IFNULL(t.nombre_tem, "NULL") nombre_tem, IFNULL(ti.nombre_trabajo, "NULL")nombre_trabajo, IFNULL(ap.nombre_area_apoyo,"NULL") nombre_area_apoyo, u.mailing, p.nombre_puesto, u.status');
      $this->db->from('usuarios u');
      $this->db->join('puesto p','u.puesto = id_puesto', 'inner');
    ...
    //RELATORES
    public function getUsuariosPDFRelator()
    {
      $this->db->select('u.id_usuarios, u.username, u.nombre, u.a_paterno, u.a_materno, u.edad, g.nombre_gen, n.nombre_nac, e.nombre_est, m.nombre_mun, u.email, i.nombre_ins, f.nombre_fac, a.nombre_aca, IFNULL(t.nombre_tem, "NULL") nombre_tem, IFNULL(ti.nombre_trabajo, "NULL")nombre_trabajo, IFNULL(ap.nombre_area_apoyo,"NULL") nombre_area_apoyo, u.mailing, p.nombre_puesto, u.status');
      $this->db->from('usuarios u');
      $this->db->join('puesto p','u.puesto = id_puesto', 'inner');
    ...
    //EVALUADORES
    public function getUsuariosPDFEvaluador()
    {
      $this->db->select('u.id_usuarios, u.username, u.nombre, u.a_paterno, u.a_materno, u.edad, g.nombre_gen, n.nombre_nac, e.nombre_est, m.nombre_mun, u.email, i.nombre_ins, f.nombre_fac, a.nombre_aca, IFNULL(t.nombre_tem, "NULL") nombre_tem, IFNULL(ti.nombre_trabajo, "NULL")nombre_trabajo, IFNULL(ap.nombre_area_apoyo,"NULL") nombre_area_apoyo, u.mailing, p.nombre_puesto, u.status');
      $this->db->from('usuarios u');
      $this->db->join('puesto p','u.puesto = id_puesto', 'inner');
    ...
    //LOGISTICO
    public function getUsuariosPDFLogistico()
    {
      $this->db->select('u.id_usuarios, u.username, u.nombre, u.a_paterno, u.a_materno, u.edad, g.nombre_gen, n.nombre_nac, e.nombre_est, m.nombre_mun, u.email, i.nombre_ins, f.nombre_fac, a.nombre_aca, IFNULL(t.nombre_tem, "NULL") nombre_tem, IFNULL(ti.nombre_trabajo, "NULL")nombre_trabajo, IFNULL(ap.nombre_area_apoyo,"NULL") nombre_area_apoyo, u.mailing, p.nombre_puesto, u.status');
      $this->db->from('usuarios u');
      $this->db->join('puesto p','u.puesto = id_puesto', 'inner');
    ...
    //ASISTENTES
    public function getUsuariosPDFAsistente()
    {
      $this->db->select('u.id_usuarios, u.username, u.nombre, u.a_paterno, u.a_materno, u.edad, g.nombre_gen, n.nombre_nac, e.nombre_est, m.nombre_mun, u.email, i.nombre_ins, f.nombre_fac, a.nombre_aca, IFNULL(t.nombre_tem, "NULL") nombre_tem, IFNULL(ti.nombre_trabajo, "NULL")nombre_trabajo, IFNULL(ap.nombre_area_apoyo,"NULL") nombre_area_apoyo, u.mailing, p.nombre_puesto, u.status');
      $this->db->from('usuarios u');
      $this->db->join('puesto p','u.puesto = id_puesto', 'inner');
