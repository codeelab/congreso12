		...
		<table width='94%' border='0' cellspacing='0' cellpadding='0'>
			<tr><td>
              ...
              <div style='font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #57697e;'>
                <p >Estimado (a), <b>{$datos['nombre']} {$datos['a_paterno']} {$datos['a_materno']}</b></p>
                <p>Te tenemos buenas noticias, el servicio de <b>REGISTRO</b> para el 12° Congreso Estatal de Ciencia, Tecnología e Innovación ya ha sido habilitado.</p>
