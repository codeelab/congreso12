...
class Organizador_model extends CI_Model {
 ...
 //--------------------------------------------------------------
    ...
    {
      $this->db->select('u.id_usuarios, u.nombre, u.a_paterno, u.a_materno, p.nombre_puesto, u.status, u.puesto');
      $this->db->from('usuarios u');
      $this->db->join('puesto p','p.id_puesto = u.puesto', 'inner');
      $this->db->where('u.puesto IS NOT NULL');
      $this->db->having('u.puesto <> 1 AND u.puesto <> 8');
 ...
 //--------------------------------------------------------------
  ...
  {
    $query = $this->db->query('SELECT COUNT(*)  AS total FROM usuarios WHERE puesto IS NOT NULL GROUP BY  puesto <> 1 AND puesto <> 8 LIMIT 1,1');
 ...
 //--------------------------------------------------------------
  ...
  {
    $query = $this->db->query('SELECT COUNT(*) as totalAs FROM usuarios WHERE puesto IS NOT NULL GROUP BY puesto <> 1 AND puesto <> 8 LIMIT 1,1');
 ...
 //--------------------------------------------------------------
  ...
  {
    $query = $this->db->query('SELECT COUNT(id_usuarios) AS total FROM usuarios WHERE puesto = 2');
...
//------------------------------------------------------------------------
 ...
 //------------------------------------------------------------------------
  ...
  {
    $query = $this->db->query('SELECT COUNT(mesa) AS total FROM usuarios WHERE mesa IS NOT NULL GROUP BY  puesto <> 1 AND puesto <> 8 LIMIT 1,1');
 ...
 // LISTA USUARIOS NO EVALUADOS MESA 1
  ...
  {
    $query = $this->db->query('SELECT COUNT(id_ponencias) AS total FROM ponencias WHERE  mesa_id = 1 AND status_id = 3');
