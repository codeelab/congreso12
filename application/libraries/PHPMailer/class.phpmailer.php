...
//  public $From              = 'informatica.cecti@gmail.com';
  public $From              = 'congresocecti@gmail.com';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Área de Informática CECTI';
   ...
   * @var string
   */
  public $Subject           = 'Registro de Ponente en el 9o. Congreso Estatal de Ciencia, Tecnología e Innovación';
   ...
   * @var string
   */
  public $Username      = 'informatica.cecti';
//  public $Username      = 'congresocecti';

  /**
   * Sets SMTP password.
   * @var string
   */
 public $Password      = 'cecti2014';
// public $Password      = '10congreso';
